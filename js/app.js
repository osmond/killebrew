...
//killebrew menu
document.querySelector('#btn-killebrew').addEventListener ('click', function () {
  document.querySelector('#killebrew').className = 'fade-in';
});
document.querySelector('#killebrew ').addEventListener ('click', function () {
